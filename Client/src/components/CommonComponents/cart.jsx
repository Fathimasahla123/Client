...
// import { removeCartItem, updateQuantity, clearCart } from "../redux/productSlice";
...
//     // You can navigate to order confirmation page here
//   };
...
//             {cartItems.map(item => (
//               <div key={item._id} className="bg-white rounded-lg shadow-md p-4 mb-4 flex flex-col md:flex-row">
//                 <img 
//                   src={item.images} 
//                   alt={item.name}
...
//                     -
//                   </button>
//                   <span className="bg-gray-100 px-4 py-1">{item.qty}</span>
//                   <button 
//                     onClick={() => handleQuantityChange(item._id, item.qty + 1)}
