...
const ProductsManagement = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Merge category and newCategory
      const finalCategory =
      ...
      const submitData = {
        ...
        newCategory: undefined, // Remove newCategory from payload
      };

      await axios.post(`${apiUrl}/api/product/upload-product`, submitData, {
        headers: {
  ...
  const handleUpdateProduct = async (e) => {
    ...
    try {
      ...
      const finalCategory =
        editingProduct.newCategory?.trim() !== ""
          ? editingProduct.newCategory
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <select
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                        required={
                          !formData.newCategory && !editingProduct?.newCategory
                        }
                      >
                      ...
                      <input
                        ...
                        value={
                          editingProduct?.newCategory || formData.newCategory
                        }
                        onChange={
                          editingProduct
                            ? (e) =>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-3 md:grid-cols-4 gap-4 mt-4">
                        {(editingProduct?.images || formData.images).map(
                          (img, index) => (
