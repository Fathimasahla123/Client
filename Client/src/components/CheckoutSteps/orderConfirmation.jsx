...
//   // Sample order data - in a real app you would receive this from your backend
//   const orderDetails = {
...
//           <p><span className="font-medium">Estimated {orderDetails.delivery ? 'Delivery' : 'Pickup'}:</span> {orderDetails.estimatedDelivery}</p>
//         </div>
...
//     // Fetch order details if not passed in location state
...
//         <p className="text-xl text-gray-600 mb-8">
//           We couldn't retrieve your order details.
//         </p>
//         <Link
//           to="/orders"
//           className="px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-md font-medium transition-colors"
...
//   const estimatedTime = new Date(orderDetails.createdAt);
//   estimatedTime.setMinutes(estimatedTime.getMinutes() + 45); // Add 45 minutes
...
//         <h2 className="text-xl font-semibold mb-4">Order Details</h2>
//         <div className="space-y-2">
//           <p><span className="font-medium">Order Number:</span> #{orderDetails._id}</p>
